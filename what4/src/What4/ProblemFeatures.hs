...
--
-- Structs are modeled using constructors in CVC4(/5)/Z3, and tuples
-- in Yices.
...
--
--   Strings have some symbolic support in CVC4/5 and Z3.
useStrings :: ProblemFeatures
useStrings = ProblemFeatures 0x200

-- | Indicates whether the problem uses floating-point
--
--   Floating-point has some symbolic support in CVC4/5 and Z3.
