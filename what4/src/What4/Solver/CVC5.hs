...
cvc5PathOLD :: ConfigOption (BaseStringType Unicode)
cvc5PathOLD = configOption knownRepr "cvc5_path"

cvc5RandomSeed :: ConfigOption BaseIntegerType
cvc5RandomSeed = configOption knownRepr "solver.cvc5.random-seed"

cvc5RandomSeedOLD :: ConfigOption BaseIntegerType
cvc5RandomSeedOLD = configOption knownRepr "cvc5.random-seed"
...
cvc5TimeoutOLD :: ConfigOption BaseIntegerType
cvc5TimeoutOLD = configOption knownRepr "cvc5_timeout"
...
cvc5Options =
  ...
  in [ p1, r1, t1
     ...
     , deprecatedOpt [p1] $ pathOpt cvc5PathOLD
     , deprecatedOpt [r1] $ intWithRangeOpt cvc5RandomSeedOLD
       (negate (2^(30::Int)-1)) (2^(30::Int)-1)
     , deprecatedOpt [t1] $ tmOpt cvc5TimeoutOLD
     ] <> SMT2.smtlib2Options
